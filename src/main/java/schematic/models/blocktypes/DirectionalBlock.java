...
public abstract class DirectionalBlock extends Block {
	 ...
	 * @author klaue
	 */
	public enum Direction {/** None */ NONE, /** Up */ UP, /** Down */ DOWN, /** North */ N("north"), /** Northnortheast */ NNE("north north east"), /** Northeast */ NE("north east"),
		/** Eastnortheast */ ENE("east north east"), /** East */ E("east"), /** Eastsoutheast */ ESE("east south east"), /** Southeast */ SE("south east"),
		/** Southsoutheast */ SSE("south south east"), /** South */ S("south"), /** Southsouthwest */ SSW("south south west"), /** Southwest */ SW("south west"),
		/** Westsouthwest */ WSW("west south west"), /** West */ W("west"), /** Westnorthwest */ WNW("west north west"), /** Northwest */ NW("north west"),
