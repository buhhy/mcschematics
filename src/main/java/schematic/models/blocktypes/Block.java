...
public class Block {
	 ...
	 */
	public enum Type {
		/** Normal blocks like dirt */							NORMAL,
		/** Chests containing items */							CHEST,
		/** Flowing and still water */							WATER,
		/** Flowing and still lava */							LAVA,
		/** Wool of all colors */								WOOL,
		/** Straight rails and corners */						RAIL,
		/** Straight powered rails */							POWERED_RAIL,
		/** Straight detector rails */							DETECTOR_RAIL,
		/** Burning and non-burning redstone torches */			REDSTONE_TORCH,
		/** Stone, wood, brick and stone brick stairs */		STAIR,
		/** Both wooden and iron doors */						DOOR,
		/** Both wooden and stone pressure plates */			PRESSUREPLATE,
		/** Both light and heavy weighted pressure plates */	WEIGHTEDPRESSUREPLATE,
		/** Both slabs and double slabs of all types (stone) */	STONESLAB,
		/** Both slabs and double slabs of all types (wood) */	WOODENSLAB,
		/** Both standing and wall signs */						SIGN,
		/** Stone bricks incl. mossy and cracked */				STONEBRICK,
		/** Red and brown huge mushrooms */						HUGEMUSHROOM,
		/** Both sticky and normal pistons */					PISTON,
		/** Both sticky and normal pistons ext. */				PISTONEXTENSION,
		/** Dispensers */ DISPENSER, /** notes */ NOTE, /** Wood */ WOOD, /** Fire */ FIRE, /** Leaves */ LEAF,
		/** Saplings */ SAPLING, /** Cactii */ CACTUS, /** Hoe'd dirt */ FARMLAND, /** Crops */ CROPS, /** Torches */ TORCH,
		/** Ladders */ LADDER, /** Levers */ LEVER, /** Buttons */ BUTTON, /** furnaces */ FURNACE, /** pumpkins */ PUMPKIN,
		/** Jack'o'lanterns */ JACKOLANTERN, /** Cake */ CAKE, /** Beds */ BED, /** Redstone repeaters */ REDSTONE_REPEATER,
		/** Juke boxes */ JUKEBOX, /** Redstone wires */ REDSTONE_WIRE, /** Tall Grass */ TALL_GRASS, /** Trap Door */ TRAP_DOOR,
		/** Stem */ STEM, /** Vines */ VINES, /** Fence gate */ FENCEGATE, /** Cauldron */ CAULDRON, /** Nether Wart */ NETHERWART,
		/** Frame of the end portal */ ENDPORTALFRAME, /** Brewing Stand */ BREWINGSTAND, /** Redstone lamp */ REDSTONELAMP,
		/** Sandstone */ SANDSTONE, /** Wooden plank */ WOODENPLANK, /** Cocoa pod */ COCOAPOD, /** Tripwire */ TRIPWIRE,
		/** Tripwire hook */ TRIPWIREHOOK, /** Ender chest */ ENDERCHEST, /** Command Block */ COMMANDBLOCK, /** Beacon */ BEACON,
		/** anvil */ ANVIL, /** flower pot */ FLOWERPOT, /** cobble wall */ COBBLESTONEWALL, /** mob heads */ MOBHEAD,
		/** activator rail */ ACTIVATOR_RAIL, /** dropper */ DROPPER, /** hopper */ HOPPER, /** block of quartz */ QUARTZBLOCK,
	...
	protected static HashMap<Short, BufferedImage> imageCache = new HashMap<Short, BufferedImage>();
	protected static float zoomCache = -1;
	...
	public static Block getInstance (short id, byte data) {
		switch (id) {
			case 5:		return new WoodenPlank(data);
			case 6:		return new Sapling(data);
			case 8:
			case 9:		return new Water(id, data);
			case 10:
			case 11:	return new Lava(id, data);
			case 17:	return new Wood(data);
			case 18:	return new Leaves(data);
			case 23:	return new Dispenser(null, (byte)0);
			case 24:	return new Sandstone(data);
			case 26:	return new Bed(data);
			case 27:	return new PoweredRail(data);
			case 28:	return new DetectorRail(data);
			case 29:
			case 33:	return new Piston(id, data);
			case 31:	return new TallGrass(data);
			case 34:	return new PistonExtension(data);
			case 35:	return new Wool(data);
			case 43:
			case 44:	return new StoneSlab(id, data);
			case 50:	return new Torch(data);
			case 51:	return new Fire(data);
			case 53: // oak
			case 67: // cobble
			case 108: // brick
			case 109: // stonebrick
			...
			case 135: // birch
			case 136: // jungle
			case 156:	return new Stair(id, data); // quartz
			case 54:	// normal chest
			case 146:	return new Chest(id); // trapped chest
			case 55:	return new RedstoneWire(data);
			case 59:	return new Crop((short)59, data); // Wheat
			case 60:	return new Farmland(data);
			case 61:
			case 62:	return new Furnace(id, data);
			case 63:
			case 68:	return new Sign(null, id, data);
			case 64:
			case 71:	return new Door(id, data);
			case 78:	return new SnowCover(data);
			case 65:	return new Ladder(data);
			case 66:	return new Rail(data);
			case 69:	return new Lever(data);
			case 70:
			case 72:	return new PressurePlate(id, data);
			case 75:
			case 76:	return new RedstoneTorch(id, data);
			case 77:	return new Button(id, data);
			case 84:	return new Jukebox(data);
			case 86:	return new Pumpkin(data);
			case 91:	return new JackOLantern(data);
			case 92:	return new Cake(data);
			case 93:
			case 94:	return new RedstoneRepeater(id, data);
			case 96:	return new TrapDoor(data);
			case 98:	return new StoneBrick(data);
			case 99:
			case 100:	return new HugeMushroom(id, data);
			case 104:
			case 105:	return new Stem(id, data);
			case 106:	return new Vines(data);
			case 107:	return new FenceGate(data);
			case 115:	return new NetherWart(data);
			case 117:	return new BrewingStand();
			case 118:	return new Cauldron(data);
			case 120:	return new EndPortalFrame(data);
			case 123:
			case 124:	return new RedstoneLamp(id);
			case 125:
			case 126:	return new WoodenSlab(id, data);
			case 127:	return new CocoaPod(data);
			case 130:	return new EnderChest(data);
			case 131:	return new TripwireHook(data);
			case 132:	return new TripWire(data);
			case 137:	return new CommandBlock();
			case 138:	return new Beacon();
			case 139: 	return new CobblestoneWall(data);
			case 140:	return new FlowerPot(data);
			case 141:	return new Crop((short)141, data); // Carrot
			case 142:	return new Crop((short)142, data); // Potato
			case 143:	return new Button(id, data);
			case 144:	return new MobHead((byte)3, (byte)8, null, data); // north facing human head - most data from tile entity
			case 145:	return new Anvil(data);
			case 147:
			case 148:	return new WeightedPressurePlate(id, data);
			case 154:	return new Hopper(null, (byte)0);
			case 155:	return new QuartzBlock(data);
			case 157:	return new ActivatorRail(data);
			case 158:	return new Dropper(null, (byte)0);
			default: return new Block(id, data);
		}
	}
	 ...
	 * @return the imagecomponent or null if images are deactivated
	 */
	public synchronized BlockComponent getComponent(float zoom) {
		return new BlockComponent(this, zoom);
	}
	
	/**
	 * Used to get the type of the current block
	 * @return the type. Type normal is a non-special, non-directional normal block without state like dirt
	 */
	public Type getType() {
		return this.type;
	}
