...
public class Slice {
	 ...
	 */
	public ImageGrid getImages(float zoom, boolean calculateWires) {
	 ...
	 */
	public BufferedImage exportImage(float zoom, boolean calculateRedstoneWires, Color background, Color gridLines) {
